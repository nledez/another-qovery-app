...
func SetupModels() *gorm.DB {
	...
	viper_user := viper.Get("QOVERY_DATABASE_MY_DB_USERNAME")
	viper_password := viper.Get("QOVERY_DATABASE_MY_DB_PASSWORD")
	viper_db := viper.Get("QOVERY_DATABASE_MY_DB_NAME")
	viper_host := viper.Get("QOVERY_DATABASE_MY_DB_HOST")
	viper_port := viper.Get("QOVERY_DATABASE_MY_DB_PORT")
